...
Source0  : https://nginx.org/download/nginx-1.20.0.tar.gz
Source1  : nginx-mainline-setup.service
Source2  : nginx-mainline.service
Source3  : nginx-mainline.tmpfiles
Source4  : https://nginx.org/download/nginx-1.20.0.tar.gz.asc
...
%prep
%setup -q -n nginx-1.20.0
cd %{_builddir}/nginx-1.20.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619023795
...
cp %{_builddir}/nginx-1.20.0/LICENSE %{buildroot}/usr/share/package-licenses/nginx-mainline/ae6e4fc32b0a44181fdd221d07eadf66679f35fb
%make_install
