...
Source0  : https://nginx.org/download/nginx-1.27.5.tar.gz
Source1  : nginx-mainline-setup.service
Source2  : nginx-mainline.service
Source3  : nginx-mainline.tmpfiles
Source4  : https://nginx.org/download/nginx-1.27.5.tar.gz.asc
...
%setup -q -n nginx-1.27.5
cd %{_builddir}/nginx-1.27.5
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744827700
