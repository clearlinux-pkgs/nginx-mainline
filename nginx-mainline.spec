...
Source0  : https://nginx.org/download/nginx-1.19.6.tar.gz
Source1  : nginx-mainline-setup.service
Source2  : nginx-mainline.service
Source3  : nginx-mainline.tmpfiles
Source4  : https://nginx.org/download/nginx-1.19.6.tar.gz.asc
...
%prep
%setup -q -n nginx-1.19.6
cd %{_builddir}/nginx-1.19.6
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608147932
...
cp %{_builddir}/nginx-1.19.6/LICENSE %{buildroot}/usr/share/package-licenses/nginx-mainline/6e98d8b31beea6d51da2f8931062669945bd8aa4
%make_install
